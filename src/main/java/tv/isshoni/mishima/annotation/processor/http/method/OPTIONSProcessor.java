...
public class OPTIONSProcessor extends SimpleHTTPMethodProcessor<OPTIONS> {
    ...
    public OPTIONSProcessor(@Inject HTTPService service, @Inject OverseerService overseerService, @Inject IWinryContext context) {
        super(service, overseerService, context, OPTIONS.class);
    }
